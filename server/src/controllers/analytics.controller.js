...
export const autoInjectObservability = async (req, res) => {
  try {
    ...
    if (language === "next") {
      ...
      const instrumentationContent = `process.env.TRACEPILOT_TOKEN = '${project._id}';\nprocess.env.TRACEPILOT_SERVICE_NAME = '${project.repoName}';\nprocess.env.TRACEPILOT_ENVIRONMENT = 'production';\n\nimport { initTracer, setupGlobalErrorCapture } from '@swapnil454/tracepilot';\n\nexport function register() {\n  initTracer();\n  setupGlobalErrorCapture();\n}\n`;
    ...
    // Track AI Usage for Observability Auto-Inject
