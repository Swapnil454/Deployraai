...
import { Loader2, Play, Search, MousePointerClick, Zap, CheckCircle2, XCircle, Clock, Mail, User, Activity, Moon, AlertCircle } from "lucide-react";
...
const InfographicTimeline = ({ events }: { events: any[] }) => {
  ...
  return (
    <div className="relative h-[260px] overflow-visible mt-4 mb-2" style={{ width: containerWidth }}>
        ...
        <div className="max-w-[1440px] w-full mx-auto">
          ...
          {!projectId || projectId === 'all' ? (
            <div className="text-center py-20 border border-zinc-800/50 bg-[#0a0a0a] rounded-xl">
              ...
              <h3 className="text-lg font-medium text-white mb-1">Select a Project</h3>
              <p className="text-zinc-500 text-sm max-w-md mx-auto">
                Please select a specific project from the top left dropdown to view and trigger workflows.
              </p>
            </div>
                      ...
                      <div className="bg-[#141414] border-b border-zinc-800/80 px-6 py-4 flex flex-col sm:flex-row sm:items-start justify-between gap-4 group hover:[&>div]:opacity-100">
                        <div>
                          <div className="flex items-center gap-4 mb-2">
                            <h3 className="text-white font-bold text-[16px] tracking-wide">{run.workflowName}</h3>
