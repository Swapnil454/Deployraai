...
export default function ObservabilityTopologyProxyPage() {
    ...
    >
      <div className="max-w-sm w-full flex flex-col items-center">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-xl font-semibold text-white mb-1">Service Topology</h1>
          <p className="text-[14px] text-zinc-400">Choose a project to view topology map</p>
        </div>
          ...
          <div className="flex flex-col gap-1 w-full max-h-[300px] overflow-y-auto pr-1">
            {loadingProjects ? (
              ...
              projects.map((p: any) => (
                <button
                  key={p._id}
                  onClick={() => router.push(`/dashboard/observability/topology/${p._id}`)}
