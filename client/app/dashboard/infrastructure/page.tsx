...
export default function InfrastructureSelectorPage() {
    ...
    >
      <div className="max-w-sm w-full flex flex-col items-center">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-xl font-semibold text-white mb-1">Infrastructure Metrics</h1>
          <p className="text-[14px] text-zinc-400">Choose a project to view metrics</p>
        </div>
          ...
          <div className="flex flex-col gap-1 w-full max-h-[300px] overflow-y-auto pr-1">
            {loadingProjects ? (
              ...
              projects.map((p: any) => (
                <button
                  key={p._id}
                  onClick={() => router.push(`/dashboard/projects/${p._id}/infrastructure`)}
