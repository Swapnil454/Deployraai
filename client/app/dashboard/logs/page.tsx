...
const VercelLogsIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-[18px] w-[18px] text-zinc-400">
    <path d="M10 7h10 M10 12h10 M10 17h10" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    <rect x="4" y="6" width="2.5" height="2.5" rx="0.5" fill="currentColor" />
    <rect x="4" y="11" width="2.5" height="2.5" rx="0.5" fill="currentColor" />
    <rect x="4" y="16" width="2.5" height="2.5" rx="0.5" fill="currentColor" />
  </svg>
);
    ...
    >
      <div className="max-w-sm w-full flex flex-col items-center">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-xl font-semibold text-white mb-1">Continue to Logs</h1>
          ...
          <div className="flex flex-col gap-1 w-full max-h-[300px] overflow-y-auto pr-1">
            {loadingProjects ? (
              ...
              projects.map((p: any) => (
                <button
                  key={p._id}
                  onClick={() => router.push(`/dashboard/logs/${p._id}`)}
